  ...
  return (
    <div className="projects__card">
      <h3 className="projects__card--title">
        <a className="projects__card--link" href="https://thedbmovie.netlify.app/">
          Movie wiki ↗
        </a>
      </h3>
      <p className="projects__card--text">
        Developed using the{" "}
        <a className="projects__card--link" href="https://developer.themoviedb.org/reference/search-movie">
          TMDB API ↗
        </a>{" "}
